...
class S3(object):
    ...
    def __init__(self, bucket=None, access=None, secret=None, use_locks=True,
                 path='', reduced_redundancy=False, gzip_formats=None):
        assert bucket is not None

        self.tilestache_s3_cache = TilestacheS3Cache(
            bucket, access, secret, use_locks, path, reduced_redundancy)
